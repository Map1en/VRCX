...
function useNotifyFeedFiltersOptions() {
...
function useWristFeedFiltersOptions() {
    const wristSettings = ref([
        {
            key: 'Location',
            name: 'Self Location',
            options: getOptions(['Off', 'On'])
...
export { useNotifyFeedFiltersOptions, useWristFeedFiltersOptions };
