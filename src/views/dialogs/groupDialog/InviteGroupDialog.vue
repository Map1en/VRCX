...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                this.$confirm('Continue? Invite User(s) To Group', 'Confirm', {
                    ...
                    callback: (action) => {
                        ...
                        const inviteLoop = () => {
                            ...
                            const newUserIdsArr = [...D.userIds];
                            const receiverUserId = newUserIdsArr.shift();
                            this.inviteGroupDialog = {
                                ...this.dialogData,
                                userIds: newUserIdsArr
                            };
                            groupRequest
                                .sendGroupInvite({
                                    groupId: D.groupId,
            ...
            // line 50, I can't find func: getUserLabel, getUserObject
            // getUserLabel() {
            //     return '';
            // },
            // getUserObject() {
