<template>
    <el-dialog
        ...
        <el-radio-group :value="notificationPosition" size="mini" @input="changeNotificationPosition">
            <el-radio label="topLeft" style="margin: 0; position: absolute; left: 35px; top: 120px" />
            <el-radio label="top" style="margin: 0; position: absolute; left: 195px; top: 120px" />
            <el-radio label="topRight" style="margin: 0; position: absolute; right: 25px; top: 120px" />
            <el-radio label="centerLeft" style="margin: 0; position: absolute; left: 35px; top: 200px" />
            <el-radio label="center" style="margin: 0; position: absolute; left: 195px; top: 200px" />
            <el-radio label="centerRight" style="margin: 0; position: absolute; right: 25px; top: 200px" />
            <el-radio label="bottomLeft" style="margin: 0; position: absolute; left: 35px; top: 280px" />
            <el-radio label="bottom" style="margin: 0; position: absolute; left: 195px; top: 280px" />
            <el-radio label="bottomRight" style="margin: 0; position: absolute; right: 25px; top: 280px" />
        </el-radio-group>
