...
/// <summary>
/// Native system monitor for CPU usage and uptime.
/// </summary>
public class SystemMonitorNative
{
    public static readonly SystemMonitorNative Instance;
    ...
    static SystemMonitorNative()
    {
        Instance = new SystemMonitorNative();
    }
